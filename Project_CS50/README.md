...
The project currently applies its train booking logic on a singular coach with **72 seats** divided into 3 seat type category (Lower: 27 seats, Middle: 18 seats, Upper: 27 seats) in a coach layout exactly similar to found in modern Indian trains. 
